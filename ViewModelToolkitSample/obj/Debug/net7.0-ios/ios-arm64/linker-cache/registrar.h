...
@class ViewModelToolkit_ModalPageHandler_ModalPageViewController;
...
@interface Microsoft_iOS__UIKit_UIContextMenuInteractionDelegate : NSObject<UIContextMenuInteractionDelegate, UIContextMenuInteractionDelegate> {
}
	-(id) init;
@end
